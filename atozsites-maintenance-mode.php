 ...
 */
function atozsites_current_user_can_bypass_vip_maintenance_mode() {
	/**
...
function vip_maintenance_mode_template_redirect() {
	if ( atozsites_current_user_can_bypass_vip_maintenance_mode() ) {
		return;
	}
 ...
 * @since 1.0
 */
function atozsites_vip_maintenance_mode_admin_bar_menu() {
	global $wp_admin_bar;
	...
	$wp_admin_bar->add_menu( array(
		...
		'title'  => apply_filters( 'atozsites_vip_maintenance_mode_admin_bar_title', __( 'Under maintenance', 'maintenance-mode' ) ),
		'meta'   => array( 'class' => 'mm-notice' ),
	) );
}
add_action( 'admin_bar_menu', 'atozsites_vip_maintenance_mode_admin_bar_menu', 8 );
 ...
 * @since 1.0
 */
function atozsites_vip_maintenance_mode_admin_scripts() {
...
add_action( 'wp_enqueue_scripts', 'atozsites_vip_maintenance_mode_admin_scripts' );
add_action( 'admin_enqueue_scripts', 'atozsites_vip_maintenance_mode_admin_scripts' );
 ...
 * @return void
 */
function atozsites_vip_maintenance_mode_load_plugin_textdomain() {
	load_plugin_textdomain( 'maintenance-mode', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
}
add_action( 'init', 'atozsites_vip_maintenance_mode_load_plugin_textdomain' );
